...
export const InputDirections = () => {
  return (
    <div className="max-w-3xl mx-auto text-left space-y-2 bg-white/5 p-4 sm:p-6 rounded-lg border border-white/10">
      <h3 className="text-lg sm:text-xl font-oswald text-accent mb-4">How It Works:</h3>
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2 text-primary text-xs sm:text-sm bg-black/40 p-2 sm:p-3 rounded-md">
      ...
      <div>
        <h4 className="text-sm sm:text-md font-medium text-accent/90 mb-2">Quick Steps:</h4>
        <ul className="list-none space-y-2">
          <li className="flex items-start text-white/80 text-sm sm:text-base">
