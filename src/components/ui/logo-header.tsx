...
export const LogoHeader = ({ children, className }: LogoHeaderProps) => {
  ...
  return (
    <h1 className={cn(
      "text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-oswald font-bold text-destructive dark:text-white",
      "transform -skew-x-12 uppercase tracking-wider",
      "border-[3px] sm:border-[4px] md:border-[6px] border-black rounded-lg px-2 sm:px-3 md:px-4 py-2 sm:py-3",
