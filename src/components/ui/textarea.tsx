      ...
      <div className="relative rounded-md">
        <textarea
          className={cn(
            ...
            "text-gray-900 dark:text-white", // Dark gray text in light mode, white in dark mode
            ...
            borderStyle === "multicolor" && "before:absolute before:inset-0 before:rounded-md before:p-[3px] before:bg-gradient-to-r before:from-[#4CAF50] before:via-[#9C27B0] before:to-[#FF1493] before:mask-composite:subtract",
            className
          )}
          ref={ref}
          {...props}
