...
// Form data summarization and competency functions - Issue #16 Stream A
export { summarizeFormData, calculateFormCompetency } from "./formDataSummarizer";
// Form-aware AI coaching functions - Issue #16 Stream B  
export { 
  generateFormAwareWorkout, 
  getPersonalizedCoachingCues, 
  adaptCoachingStyle 
} from "./formAwareCoaching";