  ...
  return (
    ...
    >
      <div className="relative z-10 text-center space-y-4 w-full px-4">
        <h1 className="text-4xl md:text-6xl font-oswald text-primary dark:text-foreground">
          Evidence-Based Strength Programming
        </h1>
        <p className="text-lg md:text-xl mx-auto text-foreground max-w-4xl">
        ...
        <div className="mt-12 max-w-2xl mx-auto px-4">
          <div className="bg-card/80 border-2 border-destructive rounded-xl p-8 backdrop-blur-sm transform hover:scale-[1.02] transition-all">
            <div className="inline-block bg-destructive text-white px-3 py-1 rounded-full text-sm font-bold mb-4">
              Limited Time Offer
            </div>
            <h3 className="text-2xl md:text-3xl font-oswald text-foreground mb-4">
