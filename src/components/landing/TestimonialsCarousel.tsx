...
import { responsive, spacing } from "@/lib/design-tokens";
...
const testimonials = [
  {
    ...
    imagePath: "hart-bodybuilder.jpg",
    fallbackInitials: "HA"
  },
  {
    name: "Christine",
    ...
    imagePath: "christine-swimmer.jpg", 
    fallbackInitials: "CH"
  },
  {
    name: "Georgia",
      ...
      >
        <CarouselContent className="-ml-2 md:-ml-4">
          {testimonials.map((testimonial, index) => (
            <CarouselItem key={index} className={`pl-2 md:pl-4 ${responsive.grid.cols2.replace('grid', 'basis-full md:basis-1/2')}`}>
