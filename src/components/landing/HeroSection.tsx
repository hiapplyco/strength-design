...
export const HeroSection = ({
  ...
  return (
    <section className="flex flex-col items-center justify-center space-y-8 pt-12 pb-20">
      ...
      {showSubscription && (
        <div className="w-full max-w-3xl bg-card/90 backdrop-blur-sm p-8 rounded-xl mt-8 shadow-lg relative before:absolute before:-inset-[2px] before:bg-gradient-to-r before:from-black before:via-black before:to-red-600 before:rounded-xl before:-z-10">
