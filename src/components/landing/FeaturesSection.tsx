    ...
    <section className="py-20 bg-card rounded-3xl px-6 md:px-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-800 dark:text-white">Leverage advanced algorithms and real-time metrics to optimize strength gains.</p>
        </div>
        <div className="text-center space-y-4">
          <Brain className="w-16 h-16 text-primary mx-auto" />
          <h3 className="text-2xl font-oswald text-primary">Science-Backed Methods</h3>
          <p className="text-gray-800 dark:text-white">Every routine is rooted in the latest research on exercise physiology and biomechanics.</p>
        </div>
        <div className="text-center space-y-4">
          <Users className="w-16 h-16 text-primary mx-auto" />
          <h3 className="text-2xl font-oswald text-primary">Customizable Workouts</h3>
          <p className="text-gray-800 dark:text-white">Craft individualized programs for different fitness levels from beginners to elite athletes.</p>
        </div>
        <div className="text-center space-y-4">
          <Scale className="w-16 h-16 text-primary mx-auto" />
          <h3 className="text-2xl font-oswald text-primary">Scalable Solutions</h3>
          <p className="text-gray-800 dark:text-white">Easily expand your programs to serve entire gyms, teams, or online communities.</p>
        </div>
      </div>
    </section>
  );
