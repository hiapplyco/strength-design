          ...
          <div className="container mx-auto px-4 pt-16 md:pt-24">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto">
                Create professional video content for your training programs. Record, edit, and share clear instructions with your audience using our AI-powered teleprompter.
              </p>
            </div>
