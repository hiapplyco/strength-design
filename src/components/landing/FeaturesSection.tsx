...
export const FeaturesSection = () => {
  return (
    <section className="py-20 bg-card rounded-3xl px-4 md:px-6 lg:px-12 mx-4 md:mx-6 lg:mx-12">
      <div className="text-center mb-16 max-w-4xl mx-auto">
        ...
        <p className="text-base md:text-lg text-gray-800 dark:text-white px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
        <div className="text-center space-y-4 px-4">
          ...
          <p className="text-sm md:text-base text-gray-800 dark:text-white">Leverage advanced algorithms and real-time metrics to optimize strength gains.</p>
        </div>
        <div className="text-center space-y-4 px-4">
          ...
          <p className="text-sm md:text-base text-gray-800 dark:text-white">Every routine is rooted in the latest research on exercise physiology and biomechanics.</p>
        </div>
        <div className="text-center space-y-4 px-4">
          ...
          <p className="text-sm md:text-base text-gray-800 dark:text-white">Craft individualized programs for different fitness levels from beginners to elite athletes.</p>
        </div>
        <div className="text-center space-y-4 px-4">
          ...
          <p className="text-sm md:text-base text-gray-800 dark:text-white">Easily expand your programs to serve entire gyms, teams, or online communities.</p>
        </div>
      </div>
    </section>
  );
