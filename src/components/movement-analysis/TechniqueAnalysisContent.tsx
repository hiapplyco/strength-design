        ...
        <main className="relative z-10 w-full">
          <div className="container mx-auto px-4 pt-20">
            <div className="text-center mb-8">
              <LogoHeader>ENHANCED TECHNIQUE ANALYSIS</LogoHeader>
              <p className="text-lg text-foreground/80 max-w-2xl mx-auto mt-4">
                Powered by Gemini 2.0 with advanced video understanding, dynamic system prompts, and timestamp analysis
              </p>
            </div>
