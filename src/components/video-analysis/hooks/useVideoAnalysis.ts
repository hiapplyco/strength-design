...
export const useVideoAnalysis = () => {
  ...
  const analyzeVideo = async (videoUrl: string, customPrompt?: string) => {
    ...
    try {
      ...
      // Video analysis is temporarily disabled during Firebase migration
      throw new Error("Video analysis is temporarily unavailable during system migration. Please try again later.");
