    ...
    <div className="relative min-h-screen backdrop-blur-sm">
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-2 animate-fade-in">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-oswald font-bold text-destructive dark:text-white mb-8 transform -skew-x-12 uppercase tracking-wider text-center border-[6px] border-black rounded-lg px-6 py-4 mt-8 shadow-[inset_0px_0px_0px_2px_rgba(255,255,255,1),8px_8px_0px_0px_rgba(255,0,0,1),12px_12px_0px_0px_#C4A052]">
            strength.design
          </h1>
          <HeroSection
            generatePrompt=""
